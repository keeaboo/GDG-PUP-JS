...
// Using let
let username = "Juan Cruz"; // Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["singing", "gaming", "coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]

// Checking types and values
console.log(typeof username); // Output: should be "string"  (until a value is assigned)
...
hobbies = "dancing";
console.log(typeof hobbies); // hobbies became a string
username = 2038;
console.log(typeof username); // username became a number
...
const favoriteBooks = ["1984", "Brave New World", "Fahrenheit 451"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// isEmployed = "dancing";
// console.log(typeof isEmployed);  error

// Using var
var city = "Tokyo"; // Define a string here, e.g., "New York"
...
temperature = "Hey";
console.log(typeof temperature); // temperature became a string